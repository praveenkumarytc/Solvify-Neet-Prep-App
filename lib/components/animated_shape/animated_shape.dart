...
import 'package:shield_neet/components/animated_shape/top_shape.dart';
...
class AnimatedShape extends StatefulWidget {
  ...
  const AnimatedShape({super.key, required this.color, required this.show, required this.title});
