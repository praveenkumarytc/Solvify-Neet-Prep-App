...
class NotificationServices {
  ...
  void handleMessage(BuildContext context, RemoteMessage message) {
    // Navigator.push(context, MaterialPageRoute(builder: (context) => const SubjectWiseQuestScreen()));
    log(message.data.entries.first.value);
    // log(' this is data ${message.data['type']}');
    // if (message.data['type'] == 'message') {
    //   log('handle message called');
    // }
  }
